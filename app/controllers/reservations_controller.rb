class ReservationsController < ApplicationController
  ...
  def create
    ...
    if @restaurant.available(reservation_params[:number_of_seats].to_i, reservation_params[:time_of_reservation].to_time, params[:restaurant_id])
      if @reservation.save
        redirect_to restaurant_reservations_url, notice: "Reserved!!"
      else
